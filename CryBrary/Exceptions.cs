...
{
	/// <summary>
	/// Represents an exception that is thrown when there is an attempt to use something that requires a certain attribute..
	/// </summary>
	[Serializable]
	public class AttributeUsageException : Exception
	{
		...
		/// <summary>
		/// Creates a new instance of <see cref="AttributeUsageException" /> class with specified
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="AttributeUsageException" /> class with serialized data.
		/// </summary>
		/// <param name="info">
	...
	public class NullPointerException : Exception
	{
		...
		/// <summary>
		/// Creates a new instance of <see cref="NullPointerException" /> class with specified
		/// message and exception object that caused new one to be created.
		/// </summary>
		/// <param name="message">
		/// Message to supply with exception.
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NullPointerException" /> class with serialized data.
		/// </summary>
		/// <param name="info">
		/// The object that holds the serialized object data.
		/// </param>
