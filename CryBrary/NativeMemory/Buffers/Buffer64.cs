...
namespace CryEngine.NativeMemory
{
	...
	public unsafe struct Buffer64 : IBuffer
	{
		#region Fields
		/// <summary>
		...
		/// </param>
		public Buffer64(byte[] array, ulong shift)
			: this()
		{
		...
		/// </param>
		/// <param name="index">
		/// Zero-based index of the first of 64 bytes within native
		/// memory cluster.
		/// </param>
		...
		/// </param>
		/// <param name="offset">
		/// Zero-based index of first of 64 bytes within native memory
		/// cluster to get.
		/// </param>
