...
namespace CryEngine.NativeMemory
{
	...
	public unsafe struct Buffer32 : IBuffer
	{
		#region Fields
		/// <summary>
		...
		/// </param>
		public Buffer32(byte[] array, ulong shift)
			: this()
		{
		...
		/// </param>
		/// <param name="index">
		/// Zero-based index of the first of 32 bytes within native
		/// memory cluster.
		/// </param>
		...
		/// </param>
		/// <param name="offset">
		/// Zero-based index of first of 32 bytes within native memory
		/// cluster to get.
		/// </param>
