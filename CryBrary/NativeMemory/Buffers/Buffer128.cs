...
namespace CryEngine.NativeMemory
{
	...
	public struct Buffer128 : IBuffer
	{
		#region Fields
		/// <summary>
		...
		public Buffer128(byte[] array, ulong startIndex, ulong count)
			: this()
		{
		...
		/// <param name="index">
		/// Zero-based index of the first of 128 bytes within native memory cluster.
		/// </param>
		...
		/// <param name="offset">
		/// Zero-based index of first of 128 bytes within native memory cluster to get.
		/// </param>
		...
		/// <param name="handle">Pointer to the beginning of native memory cluster.</param>
		/// <param name="offset">
		/// Zero-based index of first of 128 bytes within native memory cluster to set.
		/// </param>
