...
namespace CryEngine.StaticObjects.Native
{
	...
	/// </summary>
	public static class NativeStaticObjectMethods
	{
		/// <summary>
		...
		extern public static IntPtr CreateStaticObject();
		/// <summary>
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		extern public static void ReleaseStaticObject(IntPtr handle);
	}
}