...
namespace CryEngine.Utilities
{
	...
	public static class CryPak
	{
		...
		/// "C:\CryENGINE3"
		/// </example>
		private static string RootFolder { get { return Directory.GetCurrentDirectory(); } }
		...
		/// <summary>
		/// Gets the engine folder. CryENGINE uses this store engine content which is not specific
		/// to the game being developed, i.e. shaders and configuration files.
		/// </summary>
		/// <returns>
		...
		/// <summary>
		/// Gets the folder in which the engine stores scripts. We use this as the root for our .cs
		/// files and .dll plugins.
		/// </summary>
		/// <returns>
