...
{
	/// <summary>
	/// Represents an exception that is thrown when error happens during remote invocation.
	/// </summary>
	...
	public class RemoteInvocationException : Exception
	{
		...
		/// <summary>
		/// Creates a new instance of <see cref="RemoteInvocationException"/> class with specified message.
		/// </summary>
		...
		/// <summary>
		/// Creates a new instance of <see cref="RemoteInvocationException"/> class with specified
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="RemoteInvocationException"/> class with
		/// serialized data.
		/// </summary>
