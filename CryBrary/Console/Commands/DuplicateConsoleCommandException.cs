...
namespace CryEngine.Console.Commands
{
	...
	{
		/// <summary>
		/// Creates a default instance of <see cref="DuplicateConsoleCommandException"/> class.
		/// </summary>
		public DuplicateConsoleCommandException()
		{
		}
		/// <summary>
		/// Creates a new instance of <see cref="DuplicateConsoleCommandException"/> class with specified
		/// message.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DuplicateConsoleCommandException"/> class with
		/// serialized data.
		/// </summary>
