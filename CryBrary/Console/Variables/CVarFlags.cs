...
namespace CryEngine.Console.Variables
{
	...
	public enum CVarFlags
	{
		...
		/// <summary>
		/// This variable is set as VF_CHEAT but doesn't have to be checked/hashed since it's harmless to
		/// workaround
		/// </summary>
		...
		/// <summary>
		/// can be changed on client and when connecting the var not sent to the client (is set for all
		/// vars in Game/scripts/Network/cvars.txt)
		/// </summary>
