...
namespace System
{
	...
	public struct Half : IComparable, IFormattable, IConvertible, IComparable<Half>, IEquatable<Half>
	{
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of System.Half to the value of the specified single-precision
		...
		/// <summary>
		/// Initializes a new instance of System.Half to the value of the specified double-precision
		/// floating-point number.
		/// </summary>
		/// <param name="value">The value to represent as a System.Half.</param>
		...
		/// <summary>
		/// Returns a value indicating whether a specified System.Half is greater than another
		/// specified System.Half.
		/// </summary>
		/// <param name="half1">A System.Half.</param>
		/// <param name="half2">A System.Half.</param>
		...
		public static bool operator >(Half half1, Half half2) { return (float)half1 > (float)half2; }
		/// <summary>
		/// Returns a value indicating whether a specified System.Half is less than or equal to
		...
		/// <summary>
		/// Returns a value indicating whether a specified System.Half is greater than or equal to
		/// another specified System.Half.
		/// </summary>
		/// <param name="half1">A System.Half.</param>
		/// <param name="half2">A System.Half.</param>
		...
		/// <returns>
		/// A signed number indicating the relative values of this instance and value. Return Value
		...
		/// <summary>
		/// Returns a half-precision floating point number converted from two bytes at a specified
		...
		/// startIndex is greater than or equal to the length of value minus 1, and is less than or
		/// equal to the length of value minus 1.
		/// </exception>
		...
		/// </param>
		/// <returns>
		/// Parameter value1 or value2, whichever is larger. If value1, or value2, or both val1 and
		/// value2 are equal to System.Half.NaN, System.Half.NaN is returned.
		/// </returns>
		...
		/// </param>
		/// <returns>
		/// Parameter value1 or value2, whichever is smaller. If value1, or value2, or both val1 and
		/// value2 are equal to System.Half.NaN, System.Half.NaN is returned.
		/// </returns>
		...
		/// <param name="half">A half-precision floating-point number.</param>
		/// <returns>
		/// true if half evaluates to System.Half.PositiveInfinity or System.Half.NegativeInfinity;
		/// otherwise, false.
		/// </returns>
		...
		/// style elements that can be present in value. A typical value to specify is System.Globalization.NumberStyles.Number.
		/// </param>
		/// <returns>
		...
		/// </param>
		/// <param name="provider">
		/// An System.IFormatProvider object that supplies culture-specific information about the
		/// format of value.
		/// </param>
		/// <returns>
		...
		/// <summary>
		/// Converts the string representation of a number to its System.Half equivalent. A return
		/// value indicates whether the conversion succeeded or failed.
		/// </summary>
		/// <param name="value">The string representation of the number to convert.</param>
		/// <param name="result">
		/// When this method returns, contains the System.Half number that is equivalent to the
		/// numeric value contained in value, if the conversion succeeded, or is zero if the
		/// conversion failed. The conversion fails if the s parameter is null, is not a number in a
		/// valid format, or represents a number less than System.Half.MinValue or greater than
		...
		/// <param name="style">
		/// A bitwise combination of System.Globalization.NumberStyles values that indicates the
		/// permitted format of value. A typical value to specify is System.Globalization.NumberStyles.Number.
		/// </param>
		/// <param name="provider">
		/// An System.IFormatProvider object that supplies culture-specific parsing information
		/// about value.
		/// </param>
		/// <param name="result">
		/// When this method returns, contains the System.Half number that is equivalent to the
		/// numeric value contained in value, if the conversion succeeded, or is zero if the
		/// conversion failed. The conversion fails if the s parameter is null, is not in a format
		/// compliant with style, or represents a number less than System.Half.MinValue or greater
		/// than System.Half.MaxValue. This parameter is passed uninitialized.
		/// </param>
		/// <returns>true if s was converted successfully; otherwise, false.</returns>
		/// <exception cref="System.ArgumentException">
		/// style is not a System.Globalization.NumberStyles value.
