...
namespace CryEngine.Mathematics.Geometry.Meshes
{
	...
	public static class CommonTangentOperations
	{
		...
		/// <returns>
		/// Instance of type that implements <see cref="ITangent"/> interface that either uses objects of
		/// type <see cref="Single"/> or <see cref="Int16"/> for coordinates.
		/// </returns>
	...
	public static class CommonQTangentOperations
	{
		...
		/// <param name="offset"> Byte offset that is added to the <paramref name="pointer"/>.</param>
		/// <returns>
		/// Instance of type that implements <see cref="IQTangent"/> interface that either uses objects of
		/// type <see cref="Single"/> or <see cref="Int16"/> for coordinates.
		/// </returns>
