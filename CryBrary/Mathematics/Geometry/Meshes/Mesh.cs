...
namespace CryEngine.Mathematics.Geometry.Meshes
{
	...
	public abstract partial class Mesh : IMesh
	{
		...
		/// </param>
		/// <param name="warnings">
		/// List that will contain all problems that don't make exporting impossible but can still cause
		/// glitches and may crash the program.
		/// </param>
		/// <returns>
		...
		/// </summary>
		/// <remarks>Volume of triangle mesh is a sum of mixed products of vertices of all faces.</remarks>
		public virtual double Volume
		{
			get
			{
				...
				try
				{
					// Better cash the collections, just in case the mesh doesn't do it. If it does, then
					// we just create more references to the cashes.
