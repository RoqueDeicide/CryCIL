...
namespace CryEngine.Mathematics.Geometry.Meshes
{
	...
	public interface IVertex
	{
		...
		IVertex Clone { get; }
		/// <summary>
		/// When implemented, creates a vertex that is located on the line between this one and another
		/// one.
		/// </summary>
		...
		/// <summary>
		/// When implemented, creates a vertex that is spherically interpolated between this vertex and
		/// another one.
		/// </summary>
		...
		/// </summary>
		/// <remarks>
		/// Can be used to create normalized linear interpolation, which is a simple surrogate of spherical
