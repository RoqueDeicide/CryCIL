...
namespace CryEngine.Mathematics.Geometry.Meshes
{
	...
	public interface IVertex
	{
		...
		IVertex Clone { get; }
		/// <summary>
		/// When implemented, creates a vertex that is located on the line between this
		/// one and another one.
		/// </summary>
		/// <remarks>
		/// See http://en.wikipedia.org/wiki/Linear_interpolation for details.
		/// </remarks>
		/// <param name="anotherVertex">Another vertex.</param>
		/// <param name="position">     
		/// Relative position of the new vertex between 2 vertices.
		/// </param>
		...
		/// <summary>
		/// When implemented, creates a vertex that is spherically interpolated between
		/// this vertex and another one.
		/// </summary>
		...
		void Flip();
		/// <summary>
		/// When implemented, converts all vector properties of this vertex to unit
		/// vectors.
		/// </summary>
		/// <remarks>
		/// Can be used to create normalized linear interpolation, which is a simple
		/// surrogate of spherical linear interpolation.
		/// </remarks>
		void Normalize();
	}
}