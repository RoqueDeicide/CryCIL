...
{
	/// <summary>
	/// When applied to the field, allows <see cref="BlitChecker"/> to know the name of unmanaged field
	/// that corresponds to this one, if the name of this field is not the same as the name of its
	/// counter-part.
	/// </summary>
	...
	{
		/// <summary>
		/// Gets name of unmanaged type's field that corresponds to the field this attribute is applied to.
		/// </summary>
