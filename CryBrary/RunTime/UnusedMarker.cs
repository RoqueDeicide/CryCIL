...
{
	/// <summary>
	/// Defines special values that are recognized as unused by CryEngine, and ways to check usability of
	/// objects.
	/// </summary>
	public static class UnusedMarker
	{
		#region Fields
		/// <summary>
		/// If a single-precision floating point data field is equal to this value than CryEngine will
		/// ignore it.
		/// </summary>
