...
/**
* \brief Scriptbind for CMesh structure. Allows to work with meshes without copying them to Mono memory.
*/
...
public:
	...
	virtual const char *GetClassName() { return "NativeMeshMethods"; }
