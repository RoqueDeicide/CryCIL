...
struct ParticleEffectInterop : public IMonoInterop<true, true>
{
	...
	static IParticleEmitter     *SpawnEmitter(IParticleEffect *handle, const QuatTS &loc,
											  const MonoParticleSpawnParameters &parameters);
	static IParticleEmitter     *SpawnEmitterDefault(IParticleEffect *handle, const QuatTS &loc);
	...
	static void                  SetParticleParams(IParticleEffect *handle,
												   const ParticleParams &parameters);
	...
	static void                  Serialize(IParticleEffect *handle, IXmlNode *node, bool bLoading,
										   bool bChildren);
	...
	static IParticleEffect      *FindEffect(mono::string sEffectName, mono::string sSource,
											bool bLoadResources);
	static IParticleEffect      *LoadEffect(mono::string sEffectName, IXmlNode *effectNode,
											bool bLoadResources, mono::string sSource);
	static bool                  LoadLibraryInternal(mono::string sParticlesLibrary, IXmlNode *libNode,
													 bool bLoadResources);
	static bool                  LoadLibraryInternalFile(mono::string sParticlesLibrary,
														 mono::string sParticlesLibraryFile,
														 bool bLoadResources);
	static IParticleEmitter     *CreateEmitterInternal(const QuatTS &loc, const ParticleParams &Params,
													   const MonoParticleSpawnParameters &spawnParameters);
	static IParticleEmitter     *CreateEmitterInternalDefaultParameters(const QuatTS &loc,
