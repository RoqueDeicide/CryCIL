...
struct IMonoExceptions
{
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception BaseException(const char *message = nullptr,
													  mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception AppDomainUnloaded(const char *message = nullptr,
														  mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception Argument(const char *argumentName, const char *message = nullptr,
												 mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception ArgumentNull(const char *message = nullptr,
													 mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception ArgumentOutOfRange(const char *message = nullptr,
														   mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception Arithmetic(const char *message = nullptr,
												   mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception ArrayTypeMismatch(const char *message = nullptr,
														  mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception BadImageFormat(const char *message = nullptr,
													   mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception CannotUnloadAppDomain(const char *message = nullptr,
															  mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception DivideByZero(const char *message = nullptr,
													 mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception ExecutionEngine(const char *message = nullptr,
														mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception FileNotFound(const char *fileName, const char *message = nullptr,
													 mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception IndexOutOfRange(const char *message = nullptr,
														mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception InvalidCast(const char *message = nullptr,
													mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception IO(const char *message = nullptr,
										   mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception MissingMethod(const char *message = nullptr,
													  mono::exception inner = nullptr) = 0;
	//! Creates a new System.MissingMethodException object.
	//!
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception NotImplemented(const char *message = nullptr,
													   mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception NullReference(const char *message = nullptr,
													  mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception Overflow(const char *message = nullptr,
												 mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception Security(const char *message = nullptr,
												 mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception Serialization(const char *message = nullptr,
													  mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception StackOverflow(const char *message = nullptr,
													  mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception SynchronizationLock(const char *message = nullptr,
															mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception ThreadAbort(const char *message = nullptr,
													mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception ThreadState(const char *message = nullptr,
													mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception TypeInitialization(const char *type_name,
														   mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception TypeLoad(const char *message = nullptr,
												 mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception InvalidOperation(const char *message = nullptr,
														 mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception MissingField(const char *message = nullptr,
													 mono::exception inner = nullptr) = 0;
	//! Creates a new System.MissingFieldException object.
	//!
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception NotSupported(const char *message = nullptr,
													 mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception CryEngine(const char *message = nullptr,
												  mono::exception inner = nullptr) = 0;
	...
	//!
	//! @returns An IMonoException wrapper.
	VIRTUAL_API virtual mono::exception ObjectDisposed(const char *message = nullptr,
													   mono::exception inner = nullptr) = 0;
};