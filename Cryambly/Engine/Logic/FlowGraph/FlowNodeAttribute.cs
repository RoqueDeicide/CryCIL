...
{
	/// <summary>
	/// Marks types that represent flow graph nodes. Marked class has to inherit from <see cref="FlowNode"/>
	/// class, define the constructor that has the same signature as <see cref="FlowNode(ushort,IntPtr)"/>
