...
{
	/// <summary>
	/// Represents the most basic implementation of <see cref="MonoNetEntity"/>.
	/// </summary>
	public class SimpleNetEntity : MonoNetEntity
	{
		#region Construction
		/// <summary>
		...
		public SimpleNetEntity(CryEntity handle, EntityId id) : base(handle, id)
		{
		}
		#endregion
		#region Interface
