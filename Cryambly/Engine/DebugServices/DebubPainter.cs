...
namespace CryCil.Engine.DebugServices
{
	...
	/// <remarks>
	/// <para>
	/// Objects of this structure allow complicated groups of objects to be created with less code clutter
	/// by storing some common information (like colors) without constantly requesting specifications.
	/// </para>
	/// <para>
	/// Objects of this structure are not supposed to persist beyond being a simple variable. Keeping these
	/// over a long period of time may cause crashes.
	/// </para>
	/// </remarks>
	/// <example>
	/// <code source="DebugServices/Painter.cs"/>
	/// </example>
	public struct DebubPainter
	{
		#region Fields
