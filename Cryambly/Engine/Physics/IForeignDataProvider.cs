...
namespace CryCil.Engine.Physics
{
	...
	{
		/// <summary>
		/// Gets or sets the pointer to the piece of data that can be given to CryEngine object as a foreign data.
		/// </summary>
		/// <remarks>
		/// Setter in this property is used for reverse conversion.
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		/// This method doesn't need to be implemented when <see cref="ForeignDataId"/> returns <see cref="ForeignDataIds.MultiId"/>.
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		/// It is not recommended to make this
		/// </remarks>
