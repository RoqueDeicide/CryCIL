namespace CryCil.MemoryMapping
{
	...
	public static unsafe class BufferToArray
	{
		...
		/// <param name="count">  
		/// Number of bytes to copy, better not go beyond any bounds, as this method has
		/// no means of checking them.
		/// </param>
		/// <returns>
		/// A managed array of bytes copied from the buffer. Null is returned if
		/// <paramref name="pointer"/> is null or <paramref name="count"/> is not
		/// positive.
		/// </returns>
