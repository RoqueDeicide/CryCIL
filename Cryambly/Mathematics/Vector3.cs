...
using CryCil.Mathematics.Graphics;
...
namespace CryCil.Mathematics
{
	...
	public struct Vector3 : IEquatable<Vector3>, IEnumerable<float>, IComparable<Vector3>
	{
		...
		/// component, 2 for the Z component.
		/// </param>
		...
		/// <summary>
		/// Creates new <see cref="Vector3"/> from specified <see cref="Quaternion"/>
		/// instance.
		/// </summary>
		...
		/// </summary>
		/// <param name="values">
		/// A list of floating point values which specify new vector using following
		/// rules:
		...
		/// <para>
		/// If list contains 2 values they are assigned to first two components while Z is
		/// zeroed.
		/// </para>
		/// <para>
		/// If list contains 3 or more values first three values are assigned to vector
		/// components.
		/// </para>
		/// </param>
		...
		/// </summary>
		/// <param name="values">
		/// A <see cref="Dictionary{TKey,TValue}"/> which is used to initialize new
		/// vector.
		/// </param>
		...
		/// </summary>
		/// <returns>
		/// A dictionary which capacity is set to 3 where components of the vector can be
		...
		/// <returns>
		/// <see cref="ColorSingle"/> object where R is vector's X-component, G - Y, B -
		/// Z.
		/// </returns>
		...
		#region Modification
		/// <summary>
		/// Creates new instance of <see cref="Vector3"/> where Y, Z and W components are
		...
		/// <summary>
		/// Creates new instance of <see cref="Vector3"/> where X, Z and W components are
		...
		/// <summary>
		/// Creates new instance of <see cref="Vector3"/> where X, Y and W components are
		...
		/// <summary>
		/// Creates new <see cref="Vector3"/> which represents this vector with modified
		/// values.
		/// </summary>
		/// <remarks>
		/// This method allows to simplify code where this instance is a property which
		...
		/// vector to make its length match given value.
		/// </summary>
		...
		/// <returns>
		/// Length of the vector that goes from end of another vector to the end of this
		/// one.
		/// </returns>
		...
		/// <param name="vec1">Another vector.</param>
		/// <returns>
		/// Squared length of the vector that goes from end of another vector to the end
		/// of this one.
		/// </returns>
		...
		/// <returns>
		/// Length of the vector that goes from end of another vector to the end of this
		/// one and projected onto XY plane.
		/// </returns>
		...
		/// <returns>
		/// Squared length of the vector that goes from end of another vector to the end
		/// of this one and projected onto XY plane.
		/// </returns>
		...
		/// <returns>
		/// True, if difference between this vector and zero vector is within specified
		/// precision bounds.
		/// </returns>
		...
		/// <param name="epsilon">Precision of comparison.</param>
		/// <returns>
		/// True, if difference between this vector and another vector is within specified
		/// precision bounds.
		/// </returns>
