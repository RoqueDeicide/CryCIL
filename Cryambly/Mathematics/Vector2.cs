...
namespace CryCil.Mathematics
{
	...
	public struct Vector2 : IEquatable<Vector2>, IFormattable, IEnumerable<float>, IComparable<Vector2>
	{
		...
		/// </param>
		/// <param name="result">
		/// When the method completes, contains the cubic interpolation of the two
		/// vectors.
		/// </param>
		...
		/// <param name="result">  
		/// When the method completes, contains the result of the Hermite spline
		/// interpolation.
		/// </param>
		...
		/// <param name="amount">Weighting factor.</param>
		/// <param name="result">
		/// When the method completes, contains the result of the Catmull-Rom
		/// interpolation.
		/// </param>
