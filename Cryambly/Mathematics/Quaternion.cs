...
namespace CryCil
{
	...
	/// </summary>
	/// <remarks>
	/// Quaternion is basically a rotation. If you use quaternions to define orientation
	/// of objects then in order to get vector that points forward from the object, you
	/// need to take <see cref="Vector3.Forward"/> and rotate it by this quaternion.
	/// </remarks>
	public struct Quaternion
	{
		...
		/// <summary>
		/// Treating this quaternion as a compressed rotation matrix, gets value in first
		...
		/// <returns>
		/// Quaternion that represents rotation equivalent to rotation by left quaternion
		/// with reversed vector followed up by rotation by right quaternion.
		/// </returns>
		public static Quaternion operator /(Quaternion left, Quaternion right)
		{
			return (!right * left);
		...
		/// <param name="right">Right operand.</param>
		/// <returns>
		/// If dot-product of two quaternions is less then zero then returns sum of left
		/// quaternion and reverse of right one, otherwise just returns a sum of two.
		/// </returns>
		public static Quaternion operator %(Quaternion left, Quaternion right)
		{
			var p = right;
		...
		/// <summary>
		/// Creates new quaternion that represents rotation to given vector from
		/// <see cref="Vector3.Up"/>(?) vector.
		/// </summary>
		/// <remarks>
		/// This method is used when we need to make an entity to look in a direction
		/// described by the <paramref name="vdir">vector</paramref>.
		/// </remarks>
		/// <param name="vdir">
		/// <see cref="Vector3"/> that represents direction to which we need to find a
		/// rotation.
		/// </param>
		...
		/// </summary>
		/// <remarks>Correct format = W,X,Y,Z</remarks>
		/// <param name="value">
		...
		/// <summary>
		/// Sets the value of this quaternion to one that represents rotation around given
		/// axis by given angle.
		/// </summary>
		...
		/// <summary>
		/// Sets the value of this quaternion to one that represents rotation defined by
		/// Euler angles.
		/// </summary>
		...
		/// <summary>
		/// Sets the value of this quaternion to one that represents rotation by given
		/// angle around X-axis.
		/// </summary>
		/// <param name="r">Angle of rotation in radians.</param>
		...
		/// <summary>
		/// Sets the value of this quaternion to one that represents rotation from first
		...
		{
			// Based on Stan Melax's article in Game Programming Gems Copy, since cannot
			// modify local
			Vector3 v0 = one;
			Vector3 v1 = two;
			v0.Normalize();
		...
		/// <summary>
		/// Sets value of this quaternion to value that represents rotation to given
