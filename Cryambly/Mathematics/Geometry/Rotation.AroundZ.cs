...
namespace CryCil.Geometry
{
	public partial class Rotation
	{
		...
		public static class AroundZ
		{
			...
			/// original value followed up by rotation around Z-axis.
			/// </summary>
			...
			/// transformation and follow it up with rotation around Z-axis.
			/// </remarks>
			...
			/// <param name="angle">Angle of rotation in radians.</param>
			/// <returns>
			/// <see cref="Quaternion"/> that represents rotation around Z-axis.
			/// </returns>
