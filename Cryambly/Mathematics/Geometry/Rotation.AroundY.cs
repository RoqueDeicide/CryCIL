	...
	public partial class Rotation
	{
		...
		public static class AroundY
		{
			...
			public static void Override(out Matrix33 matrix, float angle)
			{
				...
				matrix.M00 = cosine; matrix.M02 = sine;
				matrix.M20 = -sine; matrix.M22 = cosine;
			}
			/// <summary>
			/// Overrides given matrix with one that represents rotation around Y-axis.
			/// </summary>
			...
			public static void Set(ref Matrix33 matrix, float angle)
			{
				...
				matrix.M00 = c; matrix.M01 = 0; matrix.M02 = s;
				matrix.M10 = 0; matrix.M11 = 1; matrix.M12 = 0;
				matrix.M20 = -s; matrix.M21 = 0; matrix.M22 = c;
			}
			/// <summary>
			...
			/// original value followed up by rotation around Y-axis.
			/// </summary>
			...
			public static void StackUp(ref Matrix33 matrix, float angle)
			{
				...
				rm.M00 = cosine; rm.M02 = sine;
				rm.M20 = -sine; rm.M22 = cosine;
			...
			/// transformation and follow it up with rotation around Y-axis.
			/// </remarks>
			...
			/// <param name="angle">Angle of rotation in radians.</param>
			/// <returns>
			/// <see cref="Quaternion"/> that represents rotation around Y-axis.
			/// </returns>
