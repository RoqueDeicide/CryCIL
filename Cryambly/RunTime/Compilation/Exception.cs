...
namespace CryCil.RunTime.Compilation
{
	...
	public class CodeCompilationException : Exception
	{
		...
		/// <summary>
		/// Creates a new instance of <see cref="CodeCompilationException"/> class with specified
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CodeCompilationException"/> class with
		/// serialized data.
		/// </summary>
